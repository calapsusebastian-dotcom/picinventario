    ...
    <div class="wrap">
        ...
        <div class="topbar">
            <div class="brand">
                ...
                <div>
                    <h1>Bodega Especiales · Bodega PIC</h1>
                    <p class="subtitle">Remisiones movidas desde Bodega a la bodega especial — elige cuáles pasan a Trilla o Despacho</p>
                </div>
            </div>
        </div>
        ...
        <div class="kpis">
            ...
            <div class="kpi-card">
                ...
                <div>
                    <div class="kpi-label">Saldo en bodega especial</div>
        ...
        <div class="section-label">Movimientos de bodega especial ({{ $movimientos->total() }})</div>
                                ...
                                <tr class="detail-row">
                                    <td colspan="12">
                                        <div class="detail-grid">
                                            ...
                                            <div class="detail-block">
                                                <div class="detail-block-head"><span class="role-dot" style="background:var(--pic-accent)"></span><span class="detail-title">Bodega especial (saldo)</span></div>
