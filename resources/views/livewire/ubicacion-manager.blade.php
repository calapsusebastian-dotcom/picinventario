    ...
    <div class="wrap">
        ...
        <div class="topbar">
            <div class="brand">
                ...
                <div>
                    <h1>Ubicaciones · Bodega PIC</h1>
                    <p class="subtitle">Catálogo de ubicaciones que alimenta la lista desplegable de Ubicación en el registro</p>
                </div>
            </div>
        ...
        <div class="toolbar">
            <div class="search-box">
                ...
                <input type="text" wire:model.live.debounce.300ms="search" placeholder="Buscar ubicación...">
            </div>
        </div>

        <div class="section-label">Ubicaciones</div>
                        ...
                        @forelse ($ubicaciones as $u)
                            ...
                            @if ($confirmDeleteId === $u->id)
                                <tr class="confirm-row">
                                    <td colspan="2">
                                        ¿Eliminar "{{ $u->nombre }}"? Esta acción no se puede deshacer.
                            ...
                            @endif
                        @empty
                            <tr class="empty-row"><td colspan="2">No hay ubicaciones que coincidan con la búsqueda.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
    ...
    <div class="overlay{{ $showDrawer ? ' open' : '' }}" wire:click.self="closeDrawer">
        <div class="drawer">
            <div class="drawer-header">
                <h2>{{ $editingUbicacionId ? 'Editar ubicación' : 'Nueva ubicación' }}</h2>
            ...
            <form wire:submit.prevent="save">
                <div class="tab-panel active">
                    <div class="field">
                        <label>Nombre</label>
                        <input wire:model="nombre" placeholder="Ej. Bodega A - Estante 3">
